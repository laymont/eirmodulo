      ...
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a href="egresosExp.php?f1=<?php echo $_POST['ini'];?>&f2=<?php echo $_POST['fin'];?>" id="exportar">Exportar</a></li>
            <?php } ?>
      ...
      <form class="form-inline" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="rangofecha" id="rangofecha"  onKeyPress="Noenter();">
        <fieldset>
          ...
          <div class="form-group input-group">
            ...
            <input class="form-control" name="fin" type="date" required id="fin" value="<?php echo $final; ?>" max="<?php echo AHORAC; ?>">
          </div>
    ...
    <div class="col-xs-12">
      <table id="table" class="table table-bordered table-condensed table-hover sortable bootstrap-table" 
        ...
        <tr>
          ...
          <td scope="strd"><?php echo $inventario->Resultados['booking']; ?></td>
