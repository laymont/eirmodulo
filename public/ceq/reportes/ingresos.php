...
if(isset($_POST['ini']) and isset($_POST['fin'])){
	...
	$sql = sprintf("SELECT tequipos.tipo, count(inventario.tcont) AS cantidad FROM inventario, tequipos WHERE inventario.tcont = tequipos.id AND inventario.`delete` = 0 AND tequipos.tipo LIKE '2%%' AND inventario.frd BETWEEN '%s' AND '%s' GROUP BY inventario.tcont ORDER BY tequipos.tipo ASC;",$inicio,$fin);
	$recaps20->Consultar($sql);
	
	$recaps40 = new DBsPOO();
	$recaps40->Conectar(UDB,PDB);
	$recaps40->SelectDB(USERDB);
	$sql = sprintf("SELECT tequipos.tipo, count(inventario.tcont) AS cantidad FROM inventario, tequipos WHERE inventario.tcont = tequipos.id AND inventario.`delete` = 0 AND tequipos.tipo LIKE '4%%' AND inventario.frd BETWEEN '%s' AND '%s' GROUP BY inventario.tcont ORDER BY tequipos.tipo ASC;",$inicio,$fin);
...
<div class="container-fluid">
      ...
      <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a href="ingresosExp.php?f1=<?php echo $_POST['ini'];?>&f2=<?php echo $_POST['fin'];?>" id="exportar">Exportar</a></li>
            <?php } ?>
  ...
  <div class="row">
  	<div class="col-sm-6">
    <form class="form-inline" role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="rangofecha" id="rangofecha"  onKeyPress="Noenter();">
        <fieldset>
