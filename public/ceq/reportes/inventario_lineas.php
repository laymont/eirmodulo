    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li><a href="inventario_lineasEXP.php?linea=<?php echo $_POST['linea'];?>&estatus=<?php echo $estatus;?>" id="exportar">Exportar</a></li><?php } ?>
  ...
  <div class="row">
  	<div class="col-xs-12">
        <table id="table" class="table table-bordered table-condensed table-hover sortable bootstrap-table"
               ...
               data-locale="es-SP">
  <caption>
  Listado de Equipos: <?php echo $inventario->TotalResultados; ?> | Linea: <?php echo $inventario->Resultados['linea']; ?>
  </caption>
  <thead>
    <tr>
