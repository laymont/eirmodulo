...
<body>
<h2>Egresos - Lineas | <?php echo $inventario->Filas['linea']; ?></h2>
...
<table border="1" align="center" cellpadding="0" cellspacing="0" class="listado">
  ...
  <tr>
    ...
    <td scope="strd"><?php echo $inventario->Filas['precinto']; ?></td>
    ...
    <td scope="num"><?php FechaDif($inventario->Filas['frd'],$inventario->Filas['fdespims']);?></td>
    <td scope="num"><?php FechaDif($inventario->Filas['fdb'],$inventario->Filas['fdespims']);?></td>
  </tr>
